...
// a component function to create articles in HTML format
let articleMaker = obj => {
...
// get the articles to the DOM
let articleDiv = document.querySelector('.articles');

data.forEach(item => {
	let createdArticle = articleMaker(item);
	articleDiv.appendChild(createdArticle);
});
